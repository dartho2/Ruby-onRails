class MagazinesController < ApplicationController
  ...
  private
    ...
    def magazine_params
      params.require(:magazine).permit(:productname, :price, :quantity, productshipment_attributes: [:height, :weight, :width, :depth, :_destroy], product_structures_attributes: [:id, :label, :value, :_destroy])
    end
